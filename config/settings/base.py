...
OWNPAPER_ANALYTICS_BLOCK_BOTS = env_bool("OWNPAPER_ANALYTICS_BLOCK_BOTS", True)
OWNPAPER_ANALYTICS_BLOCKED_USER_AGENT_PATTERNS = env_list(
    "OWNPAPER_ANALYTICS_BLOCKED_USER_AGENT_PATTERNS"
)
OWNPAPER_ANALYTICS_FINGERPRINT_THROTTLE_ENABLED = env_bool(
    "OWNPAPER_ANALYTICS_FINGERPRINT_THROTTLE_ENABLED",
    True,
)
OWNPAPER_ANALYTICS_FINGERPRINT_THROTTLE_SECONDS = env_int(
    "OWNPAPER_ANALYTICS_FINGERPRINT_THROTTLE_SECONDS",
    60 * 60 * 6,
)
OWNPAPER_ANALYTICS_FINGERPRINT_THROTTLE_MAX_HITS = env_int(
    "OWNPAPER_ANALYTICS_FINGERPRINT_THROTTLE_MAX_HITS",
    5,
)
